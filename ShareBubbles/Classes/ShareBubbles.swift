...
public class ShareBubbles: UIView {
    public weak var delegate: ShareBubblesDelegate?
    ...
    public func show() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(ShareBubbles.faderViewTapped(_:)))
    ...
    private func createButton(attribute: ShareAttirbute) {
        ...
        button.addTarget(self, action: #selector(ShareBubbles.buttonTapped(_:)), for: .touchUpInside)
