#
# Be sure to run `pod lib lint ShareBubbles.podspec' to ensure this is a
...
Animated Social share buttons control for iOS written in Swift. This library is inspired AAShareBubbles.
  ...
  s.homepage         = 'https://github.com/douwantech/ShareBubbles'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sunfjun' => 'sunfjun@gmail.com' }
  s.source           = { :git => 'https://github.com/douwantech/ShareBubbles.git', :tag => s.version.to_s }
